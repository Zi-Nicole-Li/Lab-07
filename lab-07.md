...
``` r
# This plot oversimplified the concept of wear mask, and other situations, like quarantine policy, health baseline. The original visualization somehow have dual Y-Axis Scaling, making direct comparisons difficult. Based on this plot, it seems like mask mandates lead to higher cases initially.
